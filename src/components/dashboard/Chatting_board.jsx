    ...
    return (
        ...
        <div className='w-[100%] '>
            {isOpenchat && <div className=" w-full h-screen border border-gray-900 flex flex-col items-center text-center">
                <div className=" w-full h-[80px] flex justify-between p-4 bg-gray-800 text-white ">
                    <div className="flex justify-center items-center">
                        <img src="https://png.pngitem.com/pimgs/s/111-1114718_transparent-sleep-icon-png-person-icon-circle-png.png" alt="user avatar" className="cursor-pointer border rounded-full" width={50} height={50} />
                        <div>
                            <h1 className="ml-6 text-2xl mt-[-5px] cursor-default " > {chatting_with} </h1>
                    ...
                    <div className='flex gap-6 justify-center align-middle items-center  '>
                        <div className='hover:bg-gray-200 rounded-full p-1'>
                            <PhoneCall size={32} className="text-white hover:text-gray-900 hover:bg-gray-200 m-1 " />
                        </div>
                        <div className='hover:bg-gray-200 rounded-full p-1'>
                            <Video size={32} className="text-white hover:text-gray-900 hover:bg-gray-200 m-1 " />
                        </div>
                    </div>
                ...
                <div className=" h-full w-[100%] overflow-auto  overflow-x-hidden"
                    ...
                    <div className=" px-10 py-14 text-start">
                        ...
                        {messages2.map((messageObj, index) => (
                            <div
                                key={index}
                                className={`max-w-[60%] w-fit rounded-b-xl m-1 rounded-tr-xl p-2 ${messageObj.senderid === localStorage.getItem("Email") ? "bg-green-600 ml-auto text-white" : "text-white bg-gray-800"}`}>
                                ...
                                <span className='text-white text-lg' >{messageObj.message} </span>
                                <span className='text-gray-300 text-sm'>{messageObj.timestamp}</span>
                            </div>
                        ))}
